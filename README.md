...
- **Доделать игровые механики (механика флагов, инвентаря и событий)** - не рализованы механики вимодействия с предметами инвенторя, квесты с гадками, смешиванием зелья, поиском предметов.
